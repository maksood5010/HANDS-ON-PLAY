...
import { uploadCompanyLogo } from "../middleware/companyLogoUpload.js";
import {
...
router.post("/companies", uploadCompanyLogo, createCompanyHandler);
...
router.put("/companies/:id", uploadCompanyLogo, updateCompanyHandler);
